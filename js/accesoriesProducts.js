...
if (currentPage === 'accesoriesMen') {
  filteredProducts = storedProducts.filter(product => ( product.category.includes('Hombre') && (product.type.includes('Accesorio')) ));
} else if (currentPage === 'accesoriesWomen') {
  filteredProducts = storedProducts.filter(product => ( product.category.includes('Mujer') && (product.type.includes('Accesorio')) ));
} else if (currentPage === 'accesoriesKid') {
  filteredProducts = storedProducts.filter(product => ( product.category.includes('Niño') && (product.type.includes('Accesorio')) ));
} else {
