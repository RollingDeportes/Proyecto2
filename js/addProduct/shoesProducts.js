...
if (currentPage === 'shoesMen') {
  filteredProducts = storedProducts.filter(product => ( product.category.includes('Hombres') && (product.type.includes('Calzado')) ));
} else if (currentPage === 'shoesWomen') {
  filteredProducts = storedProducts.filter(product => ( product.category.includes('Mujeres') && (product.type.includes('Calzado')) ));
} else if (currentPage === 'shoesKids') {
  filteredProducts = storedProducts.filter(product => ( product.category.includes('Niños') && (product.type.includes('Calzado' )) ));
} else {
            ...
            <div class="p-3 right-side">
              ...
              <div class="size">
                ...
                <div class="buttons d-flex flex-row mt-5 gap-3"> <a
                    class="btn-success p-2 rounded-3 buy" href="../../error404.html">Comprar</a> <button
